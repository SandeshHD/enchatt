...
function playSound() {
    const audio = new Audio('https://sandeshhd.github.io/enchatt/public/notifications/notification.wav');
    audio.play();
}
...
const changeHandler = (selected) => {
    ...
    document.querySelectorAll('.picture').forEach(pic => {
        pic.src = `https://sandeshhd.github.io/enchatt/public/avatar/${avatar}.svg`;
    })
...
form.addEventListener('submit', function (e) {
    ...
    if (localChat && localChat.length < 1000) {
        ...
        if (addReply != '') {
            ...
            <div class="pic right-pic"><img class="picture" style="${previousMessage === clientID ? 'visibility: hidden' : ''}" src="https://sandeshhd.github.io/enchatt/public/avatar/${avatar}.svg" alt="avatar" width="50" height="50">
            </div>
...
socket.on('chat-message', (chatMessage) => {
    ...
    if (chatMessage.userID === 'admin') {
        ...
        if (chatMessage.addReply != '') {
            ...
            <div class="pic left-pic"><img class="picture" src="https://sandeshhd.github.io/enchatt/public/avatar/${chatMessage.avatar}.svg" style="${previousMessage === chatMessage.userID ? 'visibility: hidden' : ''}" alt="avatar" width="50" height="50"></div>
