...
function playSound() {
    const audio = new Audio('../notifications/notification.wav');
    audio.play();
}
...
form.addEventListener('submit', function (e) {
    ...
    if (localChat && localChat.length < 1000) {
        ...
        if (addReply != '') {
            ...
            <div class="pic right-pic"><img class="picture" style="${previousMessage === clientID ? 'visibility: hidden' : ''}" src="../avatar/${avatar}.svg" alt="avatar" width="50" height="50">
            </div>
...
socket.on('chat-message', (chatMessage) => {
    ...
    if (chatMessage.userID === 'admin') {
        ...
        if (chatMessage.addReply != '') {
            ...
            <div class="pic left-pic"><img class="picture" src="../avatar/${chatMessage.avatar}.svg" style="${previousMessage === chatMessage.userID ? 'visibility: hidden' : ''}" alt="avatar" width="50" height="50"></div>
